...
func _process(delta: float) -> void:
	is_grounded = ground_check.is_colliding()#is_on_walkable_slope()
	print(is_grounded)
...
func is_on_walkable_slope() -> bool:
	if ground_check.is_colliding():
		...
		print(ground_normal.angle_to(-gravity_direction))
		if ground_normal.angle_to(-gravity_direction) < max_slope_angle:
			return true
		else:
			return false
	return false
